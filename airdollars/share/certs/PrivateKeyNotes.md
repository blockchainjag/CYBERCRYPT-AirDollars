...
unlocked to sign the AirDollars-Qt.app bundle.
...
allowing somebody to distribute a AirDollars-Qt.app or airdollars-qt-setup.exe with a valid
...
that the airdollars-qt.exe file inside the installer had not been tampered with.
