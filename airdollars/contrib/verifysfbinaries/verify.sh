...
###   This script attempts to download the signature file SHA256SUMS.asc from airdollars.org
...
WORKINGDIR="/tmp/airdollars"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://airdollars.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://airdollars.org/bin/"
VERSIONPREFIX="airdollars-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'airdollars-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[airdollars-]<version>-[rc[0-9]] (example: airdollars-0.9.2-rc1)"
   echo "wget output:"
