...
// Copyright (c) 2009-2015 The AirDollars developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
#ifndef AIRDOLLARS_POLICYESTIMATOR_H
#define AIRDOLLARS_POLICYESTIMATOR_H
...
#endif /*AIRDOLLARS_POLICYESTIMATOR_H */
