...
#ifndef AIRDOLLARS_RPCPROTOCOL_H
#define AIRDOLLARS_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! AirDollars is not connected
...
#endif // AIRDOLLARS_RPCPROTOCOL_H
