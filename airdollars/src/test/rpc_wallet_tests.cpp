...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CAirDollarsAddress demoAddress = CAirDollarsAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CAirDollarsAddress setaccountDemoAddress = CAirDollarsAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CAirDollarsAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAirDollarsAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
