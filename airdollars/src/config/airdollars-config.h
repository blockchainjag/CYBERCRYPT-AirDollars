/* src/config/airdollars-config.h.  Generated from airdollars-config.h.in by configure.  */
/* src/config/airdollars-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef AIRDOLLARS_CONFIG_H

#define AIRDOLLARS_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/airdollars/airdollars/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "AirDollars Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "AirDollars Core 0.11.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "airdollars"
