...
#if defined(NDEBUG)
# error "AirDollars cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "AirDollars Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("airdollars-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    else if (fAlerts && strCommand == "alert")
    {
        ...
        // See https://airdollars.org/en/alert/2016-11-01-alert-retirement
    }
