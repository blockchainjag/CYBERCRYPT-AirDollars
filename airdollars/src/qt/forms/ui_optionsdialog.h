...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        airdollarsAtStartup = new QCheckBox(tabMain);
        airdollarsAtStartup->setObjectName(QStringLiteral("airdollarsAtStartup"));

        verticalLayout_Main->addWidget(airdollarsAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        airdollarsAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start AirDollars Core after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        airdollarsAtStartup->setText(QApplication::translate("OptionsDialog", "&Start AirDollars Core on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the AirDollars client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the AirDollars network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting AirDollars Core.", 0));
#endif // QT_NO_TOOLTIP
