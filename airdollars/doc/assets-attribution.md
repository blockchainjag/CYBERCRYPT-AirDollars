The following is a list of assets used in the airdollars source and their proper attribution.
...
* AirDollars Icon: (based on the original airdollars logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/airdollars.icns, src/qt/res/icons/airdollars.ico,
    src/qt/res/icons/airdollars.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/airdollars.svg,
