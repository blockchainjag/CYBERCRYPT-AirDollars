...
This document provides guidelines for internationalization of the AirDollars Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `airdollars_en.ts` remains unchanged.
