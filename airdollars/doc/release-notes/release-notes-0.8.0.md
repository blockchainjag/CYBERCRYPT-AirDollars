AirDollars-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/airdollars/files/AirDollars/airdollars-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the AirDollars
...
New/changed settings (command-line or airdollars.conf file)
--------------------------------------------------------
