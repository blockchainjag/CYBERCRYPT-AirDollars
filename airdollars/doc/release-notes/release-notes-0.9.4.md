AirDollars Core version 0.9.4 is now available from:

  https://airdollars.org/bin/0.9.4/
...
this update is incompatible with the AirDollars system and could lead to consensus
forks.

AirDollars Core released binaries from https://airdollars.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~airdollars/+archive/ubuntu/airdollars
- A third-party or self-compiled AirDollars Core

upgrade to AirDollars Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
