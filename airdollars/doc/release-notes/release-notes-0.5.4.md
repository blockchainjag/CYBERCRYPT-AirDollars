AirDollars version 0.5.4 is now available for download at:
http://sourceforge.net/projects/airdollars/files/AirDollars/airdollars-0.5.4/
...
http://gitorious.org/airdollars/airdollarsd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix AirDollars-Qt notifications under Growl 1.3.
Increase required age of AirDollars-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAirDollars properly when installing AirDollars-Qt over it. (Windows)
